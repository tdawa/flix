...
Movie.create!([
  ...
  },
  {
    ...
    description: 
    %{
      After his family is murdered by a notorious and ruthless bandit, a former police officer 
      enlists the services of two outlaws to capture him.
    }.squish,
    image_file_name: 'sholay.jpg',
    cast: 'Amitabh Bachchan, Dharmendra, Sanjeev Kumar, Hema Malini and Amjad Khan',
    released_on: "1975-08-15",
    duration: '204 min',
    director: 'Ramesh Sippy',
    rating: 'PG-13',
    total_gross: 350000000.00
  }
])
...
movie = Movie.find_by(title: 'Sholay')
movie.reviews.create!(name: "Akash Malhotra", stars: 5, comment: "It takes all the good ingredients of a western, spice it up with lots of masala and lets it simmer until you get one of the finest 'curry' westerns imaginable.")
